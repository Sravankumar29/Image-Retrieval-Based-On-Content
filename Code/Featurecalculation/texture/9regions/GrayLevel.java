...
pst=con.prepareStatement("insert into reg9 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
	int i;
	String s[];
	s=new String[2];
	double k[];
...
pst.setDouble(26,k[24]);
pst.setDouble(27,k[25]);
pst.setDouble(28,k[26]);
pst.setDouble(29,k[27]);
pst.setDouble(30,k[28]);
pst.setDouble(31,k[29]);
pst.setDouble(32,k[30]);
pst.setDouble(33,k[31]);
pst.setDouble(34,k[32]);
pst.setDouble(35,k[33]);
pst.setDouble(36,k[34]);
pst.setDouble(37,k[35]);
